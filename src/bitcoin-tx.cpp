...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s techsnetworkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  techsnetworkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded techsnetworkcoin transaction") + "\n" +
              "  techsnetworkcoin-tx [options] -create [commands]   " + _("Create hex-encoded techsnetworkcoin transaction") + "\n" +
              "\n";
