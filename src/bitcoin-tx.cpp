...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " techsnetworkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  techsnetworkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded techsnetworkcoin transaction\n" +
            "or:     techsnetworkcoin-tx [options] -create [commands]   Create hex-encoded techsnetworkcoin transaction\n" +
            "\n";
