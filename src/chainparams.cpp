...
{
    const char* pszTimestamp = "This is TNC Coin";
    const CScript genesisOutputScript = CScript() << ParseHex("456784710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        pchMessageStart[1] = 0xn1;
        pchMessageStart[2] = 0xt2;
        pchMessageStart[3] = 0xn2;
        nDefaultPort = 9888;
...
//        vSeeds.emplace_back("seed-a.techsnetworkcoin.loshan.co.uk");
//        vSeeds.emplace_back("dnsseed.thrasher.io");
//        vSeeds.emplace_back("dnsseed.techsnetworkcointools.com");
//        vSeeds.emplace_back("dnsseed.techsnetworkcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 10 * 60; // 5 minitues
        ...
        vSeeds.emplace_back("testnet-seed.techsnetworkcointools.com");
        vSeeds.emplace_back("seed-b.techsnetworkcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.nPowTargetTimespan = 10 * 30; // 5 miniutes
        consensus.nPowTargetSpacing = 1 * 30; // 30 seconds
        consensus.fPowAllowMinDifficultyBlocks = true;
