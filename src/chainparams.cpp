...
{
    const char* pszTimestamp = "A new Digital Currency TECHSNETWORK (TECHIE COIN) for launching a global platform for IT Services.";
    const CScript genesisOutputScript = CScript() << ParseHex("090584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
    ...
    //    consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1517356801; // January 31st, 2018
      ...
      //  consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
       ...
       // consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000006805c7318ce2736c0");
        ...
        genesis = CreateGenesisBlock(1613991885, 2001901938, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa629ea3aa7e41ec9b5d84bf0434ad7e04fd9aa4d16dfe206fa70b3f018c5fe58"));
        assert(genesis.hashMerkleRoot == uint256S("0xf7a51819110de0f8a04e1f91d49e7f558b797f8269d30d5a48eb392a5bd396b1"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("13.233.51.74", "13.233.51.74", true));
      //  vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
       // vSeeds.push_back(CDNSSeedData("techsnetworkcointools.com", "dnsseed.techsnetworkcointools.com"));
        //vSeeds.push_back(CDNSSeedData("techsnetworkcoinpool.org", "dnsseed.techsnetworkcoinpool.org"));
       // vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xa629ea3aa7e41ec9b5d84bf0434ad7e04fd9aa4d16dfe206fa70b3f018c5fe58"))
        ...
        chainTxData = ChainTxData{
            ...
            1613991885, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1613991885, 636736, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf3802c920ae99eec9f07ce13f95b930a29491ae11e58eafcedc7214963286080"));
        assert(genesis.hashMerkleRoot == uint256S("0xf7a51819110de0f8a04e1f91d49e7f558b797f8269d30d5a48eb392a5bd396b1"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("13.233.51.74", "13.233.51.74"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.techsnetworkcoin.loshan.co.uk", true));
       // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xf3802c920ae99eec9f07ce13f95b930a29491ae11e58eafcedc7214963286080")),
        };
...
public:
    CRegTestParams() {
       ...
       // consensus.defaultAssumeValid = uint256S("0x00");
        ...
        genesis = CreateGenesisBlock(1613991885, 0, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6303c8dded0262859dba3077031ce1b9759382625c5a719a9cf322470ea4f2a2"));
        assert(genesis.hashMerkleRoot == uint256S("0xf7a51819110de0f8a04e1f91d49e7f558b797f8269d30d5a48eb392a5bd396b1"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x6303c8dded0262859dba3077031ce1b9759382625c5a719a9cf322470ea4f2a2"))
        };
