...
{
    const char* pszTimestamp = "This is TECHIE coin.";
    const CScript genesisOutputScript = CScript() << ParseHex("030384710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
    ...
    //    consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1517356801; // January 31st, 2018
      ...
      //  consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
       ...
       // consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000006805c7318ce2736c0");
        ...
        genesis = CreateGenesisBlock(1614138042, 2000111816, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1e9eb80e6fe9f3a1958a0903815e4497ba33b5f7d8c5f17533cc0003752b7c4b"));
        assert(genesis.hashMerkleRoot == uint256S("0xdceed0241497e675a383b54731f625e5e01661bc54051cb00ef4d89188948943"));
      ...
      //  vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
       ...
       // vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x1e9eb80e6fe9f3a1958a0903815e4497ba33b5f7d8c5f17533cc0003752b7c4b"))
        ...
        chainTxData = ChainTxData{
            ...
            1614138042, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1614138042, 1612282, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1e1413eb0903906f826a6ff709a27fcb6069b9cedc3db6b7af62befb5c047f51"));
        assert(genesis.hashMerkleRoot == uint256S("0xdceed0241497e675a383b54731f625e5e01661bc54051cb00ef4d89188948943"));
       ...
       // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x1e1413eb0903906f826a6ff709a27fcb6069b9cedc3db6b7af62befb5c047f51")),
        };
...
public:
    CRegTestParams() {
       ...
       // consensus.defaultAssumeValid = uint256S("0x00");
        ...
        genesis = CreateGenesisBlock(1614138042, 0, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x63965855341067f1c8b895e9a9f051e5406b9841116286aa665b2d6fefe75633"));
        assert(genesis.hashMerkleRoot == uint256S("0xdceed0241497e675a383b54731f625e5e01661bc54051cb00ef4d89188948943"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x63965855341067f1c8b895e9a9f051e5406b9841116286aa665b2d6fefe75633"))
        };
