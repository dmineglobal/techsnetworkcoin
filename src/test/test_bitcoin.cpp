...
#define BOOST_TEST_MODULE Techsnetworkcoin Test Suite
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_techsnetworkcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
