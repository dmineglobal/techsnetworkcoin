# Support for Output Descriptors in Techsnetworkcoin Core

Since Techsnetworkcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Techsnetworkcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Techsnetworkcoin Core wallets, a convenience function `combo` is
