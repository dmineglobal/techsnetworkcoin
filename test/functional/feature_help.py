...
"""Verify that starting techsnetworkcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start techsnetworkcoin with -h for help text")
        ...
        self.log.info("Start techsnetworkcoin with -version for version information")
        ...
        self.log.info("Start techsnetworkcoind with -fakearg to make sure it does not start")
